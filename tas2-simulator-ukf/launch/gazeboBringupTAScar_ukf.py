...
def generate_launch_description():
 ...
 # Constants for paths to different files and folders
  package_name = 'tas2-simulator-ukf'
  ...
  robot_UKF_localization_node = Node(
       package='robot_localization',
       executable='ukf_node',
       name='ukf_filter_node',
       output='screen',
      parameters=[os.path.join(pkg_share, 'config/ukf.yaml'), {'use_sim_time': use_sim_time}],
  ...
  ld.add_action(robot_UKF_localization_node)
